...
def draw_grid():
    for x in range(0, square_width, pixel_width):
        pygame.draw.line(screen, "gray", (x, 0), (x, square_width))
    for y in range(0, square_width, pixel_width):
        pygame.draw.line(screen, "gray", (0, y), (square_width, y))
...
while running:
    ...
    for snake_part in snake:
        pygame.draw.rect(screen, (0, 100, 0), snake_part)
